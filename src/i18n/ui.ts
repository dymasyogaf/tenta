...
export const UI = {
  id: {
    ...
    'footer.tagline': 'Penyedia solusi digital marketing terintegrasi yang menghadirkan akses akun whitelist Google Ads, Meta Ads & TikTok Ads premium, optimasi website, dan konsultasi bisnis untuk mendukung pertumbuhan eksponensial brand di pasar lintas negara',
  ...
  en: {
    ...
    'footer.disclaimer': 'Disclaimer',
    'footer.tagline': 'An integrated digital marketing solution provider bringing premium Google Ads, Meta Ads & TikTok Ads whitelist account access, website optimization, and business consulting to support exponential brand growth across global markets.',
