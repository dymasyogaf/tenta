...
export const WEBINAR_META = {
  ...
  caseStudy: {
    eyebrow: 'Bukti Nyata',
    heading: 'Jangan Asal Scale Kalau Belum Paham Polanya',
    sub: 'Perbandingan riil performa dashboard Meta Ads sebelum dan sesudah menerapkan struktur scaling yang tepat.',
    before: {
      badge: 'BEFORE',
      title: 'Salah Strategi Scaling',
      caption: 'Biaya ATC tembus Rp 420.000/hasil akibat salah strategi scaling.',
      cprLabel: 'Biaya per Hasil (ATC)',
      cprValue: 'Rp 420.641',
      cpmLabel: 'CPM',
      cpmValue: 'Rp 927.222',
      resultsLabel: 'Total Hasil',
      resultsValue: '2 – 5 ATC',
      image: '/assets/webinar/before.jpeg',
    },
    after: {
      badge: 'AFTER',
      title: 'Struktur & Timing Tepat',
      caption: 'Biaya ATC turun ke Rp 5.456/hasil, menghasilkan 639+ konversi.',
      cprLabel: 'Biaya per Hasil (ATC)',
      cprValue: 'Rp 5.456',
      cpmLabel: 'CPM',
      cpmValue: 'Rp 31.462',
      resultsLabel: 'Total Hasil',
      resultsValue: '639 ATC',
      image: '/assets/webinar/after.jpeg',
    },
    takeaway: 'Seluruh studi kasus, pembacaan data dashboard, dan framework perbaikannya akan kita bedah tuntas di sesi live webinar.',
  },
  curriculum: {
    eyebrow: 'Materi sesi',
