...
export const META_LP: Record<Lang, MetaLpData> = {
  ...
  en: {
    ...
    hero: {
      ...
      title: "Don't Let",
      titleAccent: 'Account Issues Hinder Your Business Growth',
      desc: 'Whitelist Accounts help active advertisers run campaigns with greater peace of mind and focus on growth.',
    },
