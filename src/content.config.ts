...
const services = defineCollection({
  ...
  schema: z.object({
    ...
    singleCtaText: z.string().optional(),
    singleCtaText_en: z.string().optional(),
    singleCtaHref: z.string().optional(),
    singleCtaHref_en: z.string().optional(),
    featuresTitle: z.string().optional(),
    featuresTitle_en: z.string().optional(),
    featuresSub: z.string().optional(),
    featuresSub_en: z.string().optional(),
    hidePricing: z.boolean().optional(),
    showClientResults: z.boolean().optional(),
